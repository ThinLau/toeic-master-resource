$(document).ready(function(){
	...
	function addSubQuestionHTMLElement(selector, currQuestion, index){
		...
		'<div class="col-md-2">'+
            '<span class ="question-number text-primary" style="font-size: 22px;">Câu '+currQuestion +': </span>'+
         '</div>'+
		'<div class="col-md-10">'+
        	'<input type="text" name="question_content_'+index+'" class="form-control" placeholder="Nhập nội dung câu hỏi"/>'+
   		'</div>'+
       '</div> ';
