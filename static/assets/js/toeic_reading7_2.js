...
var txt="";
	...
	var extractno=1;
	var partslist=[4,4,4];
	var completedlist=[4,8,12];
	
	var numberofquestions=partslist[0];
	var completedquestions=0;
	var extractslist=[0,1,2];
	var extractslist2=[1,2,3];
	var readinglist=[];
...
var rand=xmlDoc.getElementsByTagName("random")[0].childNodes[0].nodeValue;
	...
	//document.getElementById("extracttoeic7").innerHTML=xmlDoc.getElementsByTagName("reading")[0].childNodes[0].nodeValue;
 ...
 for (y=0;y<s.length;y++)
 {
	...
	readinglist.push(s[y].getElementsByTagName("reading")[0].childNodes[0].nodeValue)  ;
 }
...
document.getElementById("extracttoeic7").innerHTML=readinglist[extractno-1];	 
